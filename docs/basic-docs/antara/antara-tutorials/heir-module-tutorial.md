...
<img style="border: 10px solid white;" src="https://github.com/dimxy/images/blob/master/cc-tx-structure-for-guide-v2.3.png"><!--dimxy6 temp fig location to see how it looks in the doc, to be copied into doc repo in the finished state-->
